...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', "ollama/llama2")
        self.smart_llm_model = os.getenv('SMART_LLM_MODEL', "ollama/llama2")
        ...
        self.base_url="http://0.0.0.0:11435"
